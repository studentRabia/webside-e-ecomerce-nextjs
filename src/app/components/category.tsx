         ...
         <div className="w-full flex justify-center items-center mt-10 mb-1  ">
            ...
            <div className="sm:w-full md:w-[80%]  border-b-2 border-neutral-100 pb-10 ">
                ...
                <div className="flex flex-col sm:pl-[6%] md:pl-0 ">
                    <h3 className="text-blue-950 font-bold border-l-8  border-blue-950 pl-3 ml-1">Categories</h3>
                    <div className="flex ">
                ...
                <div className="flex sm:flex-row gap-x-5 gap-y-10 md:flex-row lg:flex-row sm:justify-center md:justify-between mt-5 sm:flex-wrap  lg:flex-nowrap">
                    {/* box1 */}
                    <div className="group shadow-2xl border-solid border-2 rounded-md hover:bg-blue-500 sm:w-[120px] md:w-[200px] h-[150px] flex flex-col gap-y-5 justify-center items-center cursor-pointer relative">
                  {/* Icon mobile */}
                  ...
                  <p>Phones</p>
                    ...
                    {/* box2 */}
                    <div className="group border-solid border-2 shadow-2xl rounded-md hover:bg-blue-500  sm:w-[120px] md:w-[200px] h-[150px] flex flex-col gap-y-5 justify-center items-center cursor-pointer relative">
                  {/* Icon mobile */}
