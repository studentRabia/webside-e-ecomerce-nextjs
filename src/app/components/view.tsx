         ...
         <div className="w-full flex justify-center items-center mt-10 mb-1 ">
            ...
            <div className="sm:w-full md:w-[80%]  border-b-2 border-neutral-100 pb-10">
                ...
                <div className="flex sm:flex-row gap-x-5 gap-y-10 md:flex-row lg:flex-row sm:justify-center md:justify-between mt-5 mb-4 sm:flex-wrap  lg:flex-nowrap">
                    {/* box1 */}
                    <div className=" shadow-lg border-solid border-2 rounded-md hover:bg-blue-500 sm:w-[120px] md:w-[200px] h-[150px] flex flex-col gap-y-2 justify-center items-center cursor-pointer ">
                  {/* Icon mobile */}
                  ...
                  <p  className='sm:text-[8px]  md:text-sm'>Sallers active our site</p>
                    ...
                    {/* box2 */}
                    <div className=" border-solid border-2 shadow-2xl rounded-md hover:bg-blue-500  sm:w-[120px] md:w-[200px] h-[150px] flex flex-col gap-y-2 justify-center items-center cursor-pointer ">
                  {/* Icon mobile */}
